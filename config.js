...
let config = {
	...
	modules: [
		...
		},
		{
		    ...
		    config: { // See "Configuration options" for more information.
		      source: "local:/home/pi/Pictures/digitalframe/",
	        ...
	        },
		{
			...
			config: {
				...
				type: "current",
				location: "Snoqualmie",
				locationID: "5810995", //ID from http://bulk.openweathermap.org/sample/city.list.json.gz; unzip the gz file and find your city
				apiKey: ""
			}
		},
		{
